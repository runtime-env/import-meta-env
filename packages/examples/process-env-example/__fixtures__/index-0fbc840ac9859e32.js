...
var react = __webpack_require__(2406);
;// CONCATENATED MODULE: ../../../node_modules/.pnpm/swr@1.2.2_react@17.0.2/node_modules/swr/dist/index.mjs
...
var SWRConfig$1 = function (props) {
    ...
    var extendedConfig = mergeConfigs((0,react.useContext)(SWRConfigContext), value);
...
var useSWRHandler = function (_key, fetcher, config) {
    ...
    var initialMountedRef = (0,react.useRef)(false);
    ...
    var revalidate = (0,react.useCallback)(function (revalidateOpts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
    var boundMutate = (0,react.useCallback)(
...
function Index() {
    var ref = useSWR("/api/process-env", fetcher), data = ref.data, error = ref.error;
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("p", {
                children: [
                    ...
                    "\x00",
                    "env: ",
                    JSON.stringify({"HELLO":"import-meta-env"})
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("p", {
                children: [
